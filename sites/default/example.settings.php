...
$databases = array (
    ...
    array (
        ...
        array (
            ...
            'port' => '',
            'driver' => 'mysql',
            'prefix' => 'drupal_', // do not change the prefix as the dump file uses this!
        ),
    ),
);
 ...
 *
 */
$drupal_hash_salt = 'rgiQEpio5qdDKAVWcDDrcRO2_t1E_Vi7e5oIu586vkA'; // change the salt for every website
